...
class IncomingCallAlert {
    ...
    fun showWindow(context: Context, phone: String, patient: Patient? = null) {
        try {
            if (patient != null) {
                ...
                windowLayout?.let {
                    ...
                    val numberTextView = it.findViewById<TextView>(R.id.name)
                    numberTextView.text = patient.name
                    val dateTextView = it.findViewById<TextView>(R.id.date)
                    dateTextView.text = getTimeAgoFromLocalDateTime(patient.modifiedDateObj ?: LocalDateTime.now())
                    val descTextView = it.findViewById<TextView>(R.id.desc)
                    descTextView.text = patient.desc
